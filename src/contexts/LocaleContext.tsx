...
const translations: Record<SupportedLanguage, Record<string, string>> = {
  en: {
    ...
    'auth.freeTrial': 'Start your 7-day free trial. No credit card required.',
  ...
  fr: {
    ...
    'auth.freeTrial': 'Commencez votre essai gratuit de 7 jours. Aucune carte bleue requise.',
  ...
  ar: {
    ...
    'auth.freeTrial': 'ابدأ تجربة مجانية لمدة 7 أيام. لا تحتاج إلى بطاقة ائتمان.',
