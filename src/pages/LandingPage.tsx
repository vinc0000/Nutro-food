        ...
        <AnimatePresence mode="wait">
          ...
          >
            <img
              ...
              srcSet={`${SLIDES[currentSlide].image.replace('w=1920&h=1080', 'w=800&h=450')} 800w, ${SLIDES[currentSlide].image.replace('w=1920&h=1080', 'w=1280&h=720')} 1280w, ${SLIDES[currentSlide].image} 1920w`}
              sizes="100vw"
